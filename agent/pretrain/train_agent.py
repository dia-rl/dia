...
class PreTrainAgent:
    ...
    def __init__(self, cfg):
        ...
        # Optional resume: load model/ema/epoch from a checkpoint and continue.
        # Gated on cfg.train.resume_path; absent -> start fresh (unchanged behavior).
        self.start_epoch = 1
        ...
        if resume_path and os.path.exists(resume_path):
            ...
            self.start_epoch = int(data.get("epoch", 0)) + 1
            print(f"[resume] loaded {resume_path}, continuing from epoch {self.start_epoch}")
